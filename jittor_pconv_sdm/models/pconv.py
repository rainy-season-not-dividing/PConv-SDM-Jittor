...
class ConvBNAct(nn.Module):
    ...
    def __init__(
        ...
        self.act = nn.SiLU() if activation is True else activation if isinstance(activation, nn.Module) else Identity()
...
class PConv(nn.Module):
    ...
    def execute(self, x):
        ...
        return self.fuse(jt.concat([yw0, yw1, yh0, yh1], dim=1))
